...
class DocAppRequest extends StatefulWidget {
  const DocAppRequest({Key? key}) : super(key: key);

  @override
  State<DocAppRequest> createState() => _DocAppRequestState();
}

class _DocAppRequestState extends State<DocAppRequest> {
